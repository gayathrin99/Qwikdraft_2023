...
<br>
  ...
  <br>
    ...
    <p align="center">  
    <iframe width="560" height="315" src="https://www.youtube.com/embed/LWze3WqyX74" title="Qwikdraft- Slab details" frameborder="0" allow="accelerometer; autoplay; picture-in-picture; web-share"></iframe>
            </p>
            <br>
          </div>
          <script>
  ...
  bt.onclick = function show() {
    ...
    <div id="payment" style="display:none;"> Pay Rs.500 for drawings for the software and we will return it if you aren't satisfied
    <br>
...
{
    {
        ...
        $from="qwikdraft@gmail.com";
          $subject ='Qwikdraft - Slab Details';
          ...
          ';
          echo '<a href="/Slab Details.zip" download="Slab details"> Download </a>';
